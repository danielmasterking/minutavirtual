...
/****************************************/
    ...
    public function actionCreate()
    {
        ...
        $list_ciudades=ArrayHelper::map($ciudades,'codigo_dane','nombre');
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            $usuario_empresa_model = new UsuarioEmpresa();
            $usuario_empresa_model->setAttribute('usuario', $usuario);            
            $usuario_empresa_model->setAttribute('nit', $_POST['empresa']);
            $usuario_empresa_model->save();
    ...
    public function actionUpdate($id)
    {
        ...
        $user_empresa=UsuarioEmpresa::find()->where('usuario="'.$id.'"')->one();
        $list_ciudades=ArrayHelper::map($ciudades,'codigo_dane','nombre');
       // echo "<pre>";
       // print_r($user_empresa);
       // echo "</pre>";
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            if(UsuarioEmpresa::updateAll(['nit'=>$_POST['empresa']], ['=', 'usuario', $id ])){
