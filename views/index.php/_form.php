...
<div class="centro-costo-form">
    ...
    <?php
	   ...
	   if(in_array('administrador',$permisos) ){
		   ...
		   ?>
				...
				<?php //echo $form->field($model, 'cebe')->textInput(['maxlength' => true]) ?>
				<?php //echo $form->field($model, 'ceco')->textInput(['maxlength' => true]) ?>
   ...
   <?php //endif;?>
	...
	<?php /*echo $form->field($model, 'marca_id')->widget(Select2::classname(), [
